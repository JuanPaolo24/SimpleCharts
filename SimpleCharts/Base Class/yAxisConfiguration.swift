...
open class yAxisConfiguration {
  ...
  /// Enable this to disable the custom or automatic calculation of the Y axis and just put a default max value to calculate the Y axis from (Default = false)
  open var enableMaximumValueCalculation:Bool = false
